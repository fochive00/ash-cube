...
impl Pipeline {
    ...
    fn create_graphics_pipeline(&mut self, surface_resolution: &vk::Extent2D, descriptor_set_layout: &vk::DescriptorSetLayout) {
        ...
        let vertex_input_binding_descriptions = Vertex::vertex_input_binding_descriptions();
        let vertex_input_attribute_descriptions = Vertex::vertex_input_attribute_descriptions();
