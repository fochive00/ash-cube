...
use crate::cameras::{CameraTrait, UniformBufferObject, Camera};
...
impl App {
    ...
    fn pick_physical_device(&mut self) {
        ...
        // unsafe {
        //     for physical_device in physical_devices.as_slice() {
        //         let features = instance.get_physical_device_features(*physical_device);
        //         let properties = instance.get_physical_device_properties(*physical_device);

        //         // println!("{:?}", features);
        //         println!("{:?}", properties.device_type);
        //     }
        // }
        ...
        //         .iter()
        //         .map(|physical_device| {
        //             let is_not_discrete = vk::PhysicalDeviceType::DISCRETE_GPU != instance
    ...
    fn create_index_buffer(&mut self) {
        ...
        self.index_buffer = Some(vertex_buffer);
    }
    ...
    fn create_uniform_buffers(&mut self) {
        ...
        let ubo = camera.transform(&entity.transform());
